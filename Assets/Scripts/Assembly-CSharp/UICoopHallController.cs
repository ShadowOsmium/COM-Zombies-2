...
public class UICoopHallController : UISceneController
{
	...
	private void OnAutoMatchSelectButton(TUIControl control, int eventType, float wparam, float lparam, object data)
	{
		if (eventType == 3)
		{
			...
			tNetObject.Send(new GetRoomListRequest((int)(8001 + GameData.Instance.cur_coop_boss + GameConfig.Instance.server_group_index), 0, 10, RoomDragListCmd.ListType.not_full_not_game));
		}
	}
