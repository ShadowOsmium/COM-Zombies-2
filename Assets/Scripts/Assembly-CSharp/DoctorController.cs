...
public class DoctorController : PlayerController
{
	...
	{
		base.Awake();
		ENCHANT_SKILL_STATE = PlayerState.Create(PlayerStateType.Enchant, this);
		...
		HideEnchantGun();
		base.GetComponent<Animation>()["UpperBody_Avatar_Doctor_Skill01"].AddMixingTransform(spine);
	}
